...
//   final String docId; // شناسه مستند بیماری
//
...
//       appBar: AppBar(
//         backgroundColor: isDarkMode ? Colors.grey[900] : const Color(0xFFD1C4E9),
//         title: FutureBuilder<DocumentSnapshot>(
//           future: FirebaseFirestore.instance
//               .collection('alamat_bimari') // نام مجموعه
//               .doc(widget.docId) // شناسه مستند
//               .get(),
...
//             final title = data['title'] ?? 'نام بیماری'; // اگر داده‌ای نبود، نمایش این مقدار
//
//             return Text(
...
//                   textDirection: TextDirection.rtl,
//                   children: [
//                     tabButton(Icons.local_florist, 0), // اطلاعات
//                     const SizedBox(width: 16),
//                     tabButton(Icons.local_cafe, 1), // فواید
//                   ],
//                 ),
//               ),
...
//           } else {
//             if (index == 0 || index == 2) {
//               // هدایت به صفحه اصلی و ارسال تَب انتخاب‌شده
//               Navigator.pushReplacement(
//                 context,
//                 MaterialPageRoute(
//                   builder: (context) => HomeScreen(initialTab: index), // ارسال selectedTab
//                 ),
//               );
//             }
//             setState(() {
